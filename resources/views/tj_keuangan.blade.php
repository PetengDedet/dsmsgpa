...
@section('title', 'Pertanggungjawaban Keuangan')

@section('css')
@endsection

@section('content_header')
    <h1>Pertanggungjawaban Keuangan</h1>
@endsection
    ...
    <div class="box">
        <div class="box-heading">
            <ol class="breadcrumb">
                ...
                <li class="active">Pertanggungjawaban Keuangan</li>
            </ol>
        </div>
        <div class="box-body">
            @if (count($errors) > 0)
            ...
            @endif
            <form role="form" class="form-horizontal" method="post" action="{{url('simpan-keuangan')}}">
